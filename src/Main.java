...
public class Main {
    ...
    public static void main(String args[])  throws Exception {
        ...
        PPDP ppdp = new PPDP(new RawDataService(new OracleDAO(new DB())), new AnonymizedDataService(new OracleDAO(new DB()))); //runtime dependency injection
